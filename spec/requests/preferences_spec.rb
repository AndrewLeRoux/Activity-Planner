  ...
  describe "POST /create" do
      ...
      it "creates a new Preference" do
        expect {
          post preferences_url,
               params: { preference: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Preference" do
        expect {
          post preferences_url,
               params: { preference: invalid_attributes }, as: :json
        }.to change(Preference, :count).by(0)
      end

      it "renders a JSON response with errors for the new preference" do
        post preferences_url,
             params: { preference: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested preference" do
        ...
        patch preference_url(preference),
              params: { preference: new_attributes }, headers: valid_headers, as: :json
        preference.reload
